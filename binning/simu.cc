...
int main()
{
	...
	TH1D *h_th_x_tr = new TH1D("h_th_x_tr", ";#theta_{x}^{*}  (#murad)", 200, -600E-6, -600E-6);
	TH1D *h_th_y_tr = new TH1D("h_th_y_tr", ";#theta_{y}^{*}  (#murad)", 200, -600E-6, -600E-6);
	TH1D *h_t_tr = new TH1D("h_t_tr", ";t  (GeV^{2})", 100, 0., 0.1);
	
	TH1D *h_th_x_sm = new TH1D("h_th_x_sm", ";#theta_{x}^{*}  (#murad)", 200, -600E-6, -600E-6);
	TH1D *h_th_y_sm = new TH1D("h_th_y_sm", ";#theta_{y}^{*}  (#murad)", 200, -600E-6, -600E-6);
